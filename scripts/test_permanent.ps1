# This test installs emsdk and activates the latest toolchain using `--system` or `--permanent` flags, and checks if the environment variables and PATH are correctly updated.
